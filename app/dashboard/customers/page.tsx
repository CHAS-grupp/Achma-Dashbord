...
import Customer from '@/scripts/models/Customer'; // Importera din Mongoose-modell
import connectDB from '@/scripts/db.js'; // Anslut till databasen

export const metadata: Metadata = {
  title: 'Customers',
};

// Hämta kunder från MongoDB
...
function CustomerGrid({ customers }: { customers: CustomersTableType[] }) {
  return (
